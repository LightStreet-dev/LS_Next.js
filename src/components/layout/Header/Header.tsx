...
const LanguageChanger = dynamic(() => import("@/components/layout/Header/components/LanguageChanger/LanguageChanger"), {
  ssr: false,
});
            ...
            <>
              ...
              <div className={s.mainHeaderWrapper}>
                ...
                <div className={s.groupWrapper}>
                  <LanguageChanger />
                  <ContactButton toggleForm={toggleForm} setOpenForm={setOpenForm} />
                </div>
              </div>
            </>
          )}
